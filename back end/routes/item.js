...
router.post('/items/:id', isAuthenticatedUser, isAdmin, upload.array('images', 5), updateItem)
router.put('/items/:id', isAuthenticatedUser, isAdmin, upload.array('images', 5), updateItem)
